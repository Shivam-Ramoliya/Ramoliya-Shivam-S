...
const LoadingScreen = ({ onLoadingComplete }) => {
  ...
  return (
    <div
      className={`fixed inset-0 z-50 flex items-center justify-center bg-linear-to-br from-slate-900 via-slate-800 to-slate-900 transition-opacity duration-600 ${
